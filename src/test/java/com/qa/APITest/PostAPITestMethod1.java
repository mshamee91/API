...
public class PostAPITestMethod1 extends TestBase {
	String url;
	...
	public void PostAPI() throws ClientProtocolException, IOException, ParseException {
		...
		Object obj = parser.parse(new FileReader("C:\\Selenium\\APITest\\src\\main\\java\\com\\qa\\data\\users.json"));
		org.json.simple.JSONObject jsonobject = (org.json.simple.JSONObject)obj;
		jsonobject.put("upc", String.valueOf(upc));
		ObjectMapper mapper = new ObjectMapper();
		String reqPayload = mapper.writeValueAsString(jsonobject);
